...
public final class PropertyNames {
    ...
    public static final String CONFIG_DATA_SOURCE_DIALECT = "spring.jpa.properties.hibernate.dialect";
    public static final String CONFIG_DATA_SOURCE_DRIVER = "spring.datasource.driver-class-name";
